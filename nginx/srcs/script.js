...
document.getElementById('login-form').addEventListener('submit', function(event) {
    ...
    .then(response => response.json())
    .then(data => {
        console.log('in login js data.status     :     ', data.status);
...
document.getElementById('show-UpdateProfile').addEventListener('click', function() 
{
    console.log('in show-UpdateProfile js helllo sat')
    document.getElementById('UpdateProfile-Part').style.display = 'block';
    document.getElementById('Home_Part').style.display = 'none';
    document.getElementById('login-register').style.display = 'none';
    document.getElementById('register-part').style.display = 'none';
    document.getElementById('profile').style.display = 'none';
...
// send to api endpoint to update data of the user.
document.getElementById('update-form').addEventListener('submit', function(event) {
    console.log('update-form send data to backend to updata user')
    event.preventDefault();
    const formData = new FormData(this);
   ...
   .then(data => {
        if (data.status == 'success')
        {
            ...
            document.getElementById('register-part').style.display = 'none';
            document.getElementById('profile').style.display = 'none';
            document.getElementById('UpdateProfile-Part').style.display = 'none';
        }
        else {
...
document.getElementById('back-to-home').addEventListener('click', function() {
    ...
    document.getElementById('login-register').style.display = 'none';
    document.getElementById('register-part').style.display = 'none';
    // document.getElementById('update-part').style.display = 'none';
    document.getElementById('profile').style.display = 'none';
});
});
